                                    ...
                                    <div className="w-[50vw] mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 mt-5 p-5">
                                        ...
                                        <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                                            ...
                                            <textarea
                                                ...
                                                onChange={handleChange}
                                                class="w-full px-0 focus:ring-[#5441d7] focus:border-[#5441d7]  text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
